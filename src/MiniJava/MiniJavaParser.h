...
public:
  ...
  enum {
    RuleGoal = 0, RuleMainClass = 1, RulePermissionDesc = 2, RuleClassDeclaration = 3, 
    RuleDeclaration = 4, RuleVarDeclaration = 5, RuleMethodDeclaration = 6, 
    RuleType = 7, RuleStmtBlock = 8, RuleAssignSym = 9, RuleStmt = 10, RuleExp = 11, 
    RuleIntLiteral = 12
  };
  ...
  class  PermissionDescContext : public antlr4::ParserRuleContext {
  public:
    PermissionDescContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  PermissionDescContext* permissionDesc();
  ...
  class  AssignSymContext : public antlr4::ParserRuleContext {
  public:
    AssignSymContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    antlr4::tree::TerminalNode *INT_BIN();
